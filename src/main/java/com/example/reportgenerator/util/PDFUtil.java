...
public class PDFUtil {
    ...
    public static float drawParagraph(PDDocument doc, float newLineYHeight, PDFont font,
                                      ...
                                      float sideMargin, float verticalPageMargin) {
    ...
    public static <T extends Record & AllFieldsToStringReady> float drawSVGStructure(PDDocument doc, float startX, String content, float sideMargin, float verticalMargin, float maxWidth, float newLineYHeight, TableGenerator<T> tableGenerator) {
        PDPage lastPage = doc.getPage(doc.getNumberOfPages() - 1);
